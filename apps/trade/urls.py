...
urlpatterns = [
    ...
    path(
        "update_straddle_stragety_position",
        UpdateStraddleStrategyPosition.as_view(),
        name="update_straddle_stragety_position",
    ),
    ...
    path("square_off_user", SquareOffUser.as_view(), name="square_off_user"),
    ...
    path("adjust_all_position", AdjustAllPosition.as_view(), name="adjust_all_position"),
    path('adjust_user_position', AdjustUserPosition.as_view(), name="adjust_user_position"),
